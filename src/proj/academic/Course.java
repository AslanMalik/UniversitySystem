package proj.academic;

import proj.enums.CourseType;
import proj.utils.Database;
import proj.utils.File;
import proj.models.Student;
...
public class Course implements Serializable {
    ...
    public List<String> getTeacher() { return this.teacher; }
    public void setTeacher(List<String> teacher) { this.teacher = teacher; }

    public List<Student> getStudents() { return this.students; }
    public void setStudents(List<Student> students) { this.students = students; }

    public List<String> getPrerequisite() { return this.prerequisite; }
    public void setPrerequisite(List<String> prerequisite) { this.prerequisite = prerequisite; }

    public List<File> getCourseFiles() { return this.courseFiles; }
    public void setCourseFiles(List<File> courseFiles) { this.courseFiles = courseFiles; }
    ...
    public List<String> showPrereq(String courseId) {
        for (Course course2 : Database.getInstance().getCourses()) {
    ...
    public void addPrereq(String prereq) { this.prerequisite.add(prereq); }
    public void removePrereq(String prereq) { this.prerequisite.remove(prereq); }
