...
public class TestAll {
    ...
    static void testTeacher() {
        ...
        int before = Database.getMarks().size();
        t.putMark(st, mk);
        check("putMark(Student, Mark) persists to Database.getMarks()",
                Database.getMarks().size() == before + 1);
